...
impl fmt::Display for EnhancedRvToolsError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            EnhancedRvToolsError::InvalidFileFormat { filename, expected } => write!(
                f,
            ...
            EnhancedRvToolsError::ExcelParsingError {
                sheet,
                row,
                column,
                error,
                ...
                f,
                "Excel parsing error in sheet '{}' at row {}, column '{}': {}",
                sheet, row, column, error
            ),

            EnhancedRvToolsError::MissingRequiredSheet { sheet, filename } => write!(
                f,
                "Missing required sheet '{}' in file '{}'",
                sheet, filename
            ),
            ...
            EnhancedRvToolsError::InvalidDataStructure {
                ...
                f,
                "Invalid data structure in sheet '{}'. Expected columns: {:?}, Found: {:?}",
                sheet, expected_columns, found_columns
            ),

            EnhancedRvToolsError::ValidationRuleFailed {
                rule_name,
                field,
                value,
                reason,
                ...
                f,
                "Validation rule '{}' failed for field '{}' with value '{}': {}",
            ...
            EnhancedRvToolsError::ConfidenceThresholdNotMet {
                ...
                f,
                "Confidence threshold not met for field '{}': {:.2} < {:.2}",
            ...
            EnhancedRvToolsError::StorageAnalysisError { cluster, error } => write!(
                f,
                "Storage analysis error for cluster '{}': {}",
                cluster, error
            ),

            EnhancedRvToolsError::S2dComplianceCheckFailed {
                cluster,
                requirement,
                details,
            } => write!(
                f,
                "S2D compliance check failed for cluster '{}', requirement '{}': {}",
            ...
            EnhancedRvToolsError::InsufficientDataForAnalysis {
                ...
                f,
                "Insufficient data for analyzing cluster '{}'. Missing: {:?}",
                cluster, missing_data
            ),

            EnhancedRvToolsError::ReportGenerationFailed { template_id, error } => write!(
                f,
                "Report generation failed for template '{}': {}",
                template_id, error
            ),
            ...
            EnhancedRvToolsError::MissingReportData {
                upload_id,
                missing_variables,
            } => write!(
                f,
                "Missing report data for upload '{}'. Missing variables: {:?}",
            ...
            EnhancedRvToolsError::RelationshipViolation {
                ...
                f,
                "Relationship violation from '{}' to '{}': {}",
                from_table, to_table, details
            ),
            ...
            EnhancedRvToolsError::ConfigurationError { setting, issue } => write!(
                f,
